...
pub extern "C" fn Java_com_mockuai_myapplication_LeafLib_leafRunWithOptions(
    rt_id: u16,
...
/// @return ERR_OK on finish running, any other errors means a startup failure.
#[no_mangle]
pub extern "C" fn Java_com_mockuai_myapplication_LeafLib_leafRun(rt_id: u16, config_path: *const c_char) -> i32 {
    if let Ok(config_path) = unsafe { CStr::from_ptr(config_path).to_str() } {
...
#[no_mangle]
pub extern "C" fn Java_com_mockuai_myapplication_LeafLib_leafRunWithConfigString(rt_id: u16, config: *const c_char) -> i32 {
...
#[no_mangle]
pub extern "C" fn Java_com_mockuai_myapplication_LeafLib_leafReload(rt_id: u16) -> i32 {
...
#[no_mangle]
pub extern "C" fn Java_com_mockuai_myapplication_LeafLib_leafShutdown(rt_id: u16) -> bool {
    leaf::shutdown(rt_id)
}
...
#[no_mangle]
pub extern "C" fn Java_com_mockuai_myapplication_LeafLib_leafTestConfig(config_path: *const c_char) -> i32 {
    if let Ok(config_path) = unsafe { CStr::from_ptr(config_path).to_str() } {
