...
pub extern "C" fn Java_com_mockuai_myapplication_LeafLib_leaf_run_with_options(
    rt_id: u16,
...
/// @return ERR_OK on finish running, any other errors means a startup failure.
#[no_mangle]
pub extern "C" fn Java_com_mockuai_myapplication_LeafLib_leaf_run(rt_id: u16, config_path: *const c_char) -> i32 {
    if let Ok(config_path) = unsafe { CStr::from_ptr(config_path).to_str() } {
...
#[no_mangle]
pub extern "C" fn Java_com_mockuai_myapplication_LeafLib_leaf_run_with_config_string(rt_id: u16, config: *const c_char) -> i32 {
...
#[no_mangle]
pub extern "C" fn Java_com_mockuai_myapplication_LeafLib_leaf_reload(rt_id: u16) -> i32 {
...
#[no_mangle]
pub extern "C" fn Java_com_mockuai_myapplication_LeafLib_leaf_shutdown(rt_id: u16) -> bool {
    leaf::shutdown(rt_id)
}
...
#[no_mangle]
pub extern "C" fn Java_com_mockuai_myapplication_LeafLib_leaf_test_config(config_path: *const c_char) -> i32 {
    if let Ok(config_path) = unsafe { CStr::from_ptr(config_path).to_str() } {
